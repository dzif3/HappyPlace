...
import com.example.happyplaces.util.GetAddressFromLatLng
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mHappyDetailActivity.let {
            ...
            if (it != null){
                ...
                iv_images.setImageURI(saveImageToInternalStorage)
                et_title.setText(it.title)
                et_deskription.setText(it.description)
    ...
    //Melakukan Get alamat dari GPS Hp
        ...
        when (v?.id) {
            ...
            R.id.btn_save -> {
                when{
                    ...
                    et_deskription.text.isNullOrEmpty() -> {
            ...
            if (requestCode == GALERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        iv_images.setImageBitmap(selectedImageBitmap)
                    } catch (e: IOException) {
                        e.printStackTrace()
                        Toast.makeText(this,
                ...
                Log.e("Save Image", " path :: $saveImageToInternalStorage")
                iv_images.setImageBitmap(thumbnail)
