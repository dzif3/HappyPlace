...
class DataBaseHandler(context: Context):
    ...
    fun addHappyPlace(happyPlaceModel: HappyPlaceModel): Long{
        ...
        //dalam crud kita akan menjalankan Create dimana kita akan buat membuat sebuah data baru ke dalam database
    ...
    fun  updateHappyPlace ( happyPlaceModel: HappyPlaceModel): Int{
        ...
        //dalam crud kita akan menjalankan Update dimana kita akan buat update sebuah data baru ke dalam database
    ...
    fun deleteHappyPlace (happyPlaceModel: HappyPlaceModel): Int{
        val db = this .writableDatabase
        val succes= db.delete(TABLE_HAPPY_PLACE, KEY_ID + "=" + happyPlaceModel.id, null)
        db.close()
        return succes
    }
